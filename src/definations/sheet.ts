...
export default class Sheet {
    ...
    setCell(column: Column, row: Row, value: string): {rowKey: RowKey, columnKey: ColumnKey, cellKey: CellKey} {
    ...
    private initializePosition(colPos: number, rowPos: number): {rowKey: RowKey, columnKey: ColumnKey} {
        ...
        if(!rowKey || !colKey)
            throw new Error(`Failed to initialize position at col: ${colKey} row: ${rowKey}.`)
