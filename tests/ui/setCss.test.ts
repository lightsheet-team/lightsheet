...
describe("LightSheet", () => {
    ...
    test("Should be able to render table based on provided styles", () => {
        ...
        expect((tableBody.rows[0].children[1] as HTMLElement).style.cssText).toEqual(styleString)
    });
    ...
    test("Should be able to clear existing table style", () => {
        ...
        expect((tableBody.rows[0].children[1] as HTMLElement).style.cssText).toEqual("")
    });
